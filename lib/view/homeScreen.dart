...
import 'package:dashboard_ui/components/imageSlide.dart';
import 'package:dashboard_ui/components/images.dart';
import 'package:dashboard_ui/constants.dart';
import 'package:dashboard_ui/models/pageImage.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        ImageSlide(images: [
          PageImage(code: MyRouters.thanhLapDN,urlImage: "assets/images/baner.JPEG"),
          PageImage(code: MyRouters.keToanTronGoi,urlImage: "assets/images/baner.png"),
          PageImage(code: MyRouters.dichVuKhac,urlImage: "assets/images/baner.JPEG"),
          PageImage(code: MyRouters.visa,urlImage: "assets/images/baner.png"),
        ]
        ),
