...
class ThanhLapScreen extends StatefulWidget {
  const ThanhLapScreen({Key key}) : super(key: key);

  @override
  State<ThanhLapScreen> createState() => _ThanhLapScreenState();
}

class _ThanhLapScreenState extends State<ThanhLapScreen> {
  @override
