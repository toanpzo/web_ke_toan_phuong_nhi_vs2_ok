...
class DichVuKhacScreen extends StatefulWidget {
  const DichVuKhacScreen({Key key}) : super(key: key);

  @override
  State<DichVuKhacScreen> createState() => _DichVuKhacScreenState();
}

class _DichVuKhacScreenState extends State<DichVuKhacScreen> {
  @override
